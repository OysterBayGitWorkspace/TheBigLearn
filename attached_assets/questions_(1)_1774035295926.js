// TERMY — Extended Question Bank (162 questions, LENGTH-BALANCED)
// Correct answer is longest only ~25% of the time (was 97% before fix)
// Pattern exploitation eliminated.
...
[
  {
    ...
    "options": [
      "A clause giving the company the right to liquidate its assets at any time without board approval, which requires unanimous shareholder consent and compliance with applicable regulatory requirements",
      "The right of preferred shareholders to receive their investment back before common shareholders in an exit event",
      "A requirement for the company to distribute accumulated profits to shareholders on a quarterly basis",
      "A legal process mandated by German GmbH law for dissolving the company and distributing remaining assets"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "The investor receives 1% of total exit proceeds distributed equally among all participating shareholders",
      "The investor gets their original investment amount back once before common shareholders receive anything",
      "The investor receives a guaranteed 10x return on their investment payable at the next liquidity event",
      "The preference mechanism expires automatically after one year from the date of initial investment"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "Participating preferred gives the investor voting rights at board meetings while non-participating does not",
      "Participating preferred gets money back AND pro-rata share of remaining proceeds; non-participating chooses one or the other",
      "Participating means the investor actively participates in company operations and strategic decisions",
      "Non-participating means the investor cannot attend shareholder meetings or exercise any governance rights, a mechanism that operates through the company's existing governance framework and capital structure"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "€3M — they take the preference amount because it guarantees their full investment return, which is a widely misunderstood concept that many first-time founders incorrectly apply",
      "€3.75M — they convert to common shares because 25% of €15M exceeds the €3M preference",
      "€6.75M — they receive the €3M preference plus their 25% share of the remaining €12M proceeds",
      "€6M — they receive both the full preference amount and their proportional share simultaneously"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "€3.75M — they simply convert their preferred shares to common and take their 25% share",
      "€3M — they take only their preference amount because it guarantees a clean return of capital",
      "€6M — they get €3M preference first, then 25% of remaining €12M which equals another €3M",
      "€5.25M — they receive a blended amount calculated using the weighted average of preference and equity"
    ],
    "correct": 2,
  ...
  },
  {
    ...
    "options": [
      "A regulatory cap on the total number of participating investors allowed in any single funding round, a mechanism that operates through the company's existing governance framework and capital structure",
      "A maximum total return the participating preferred investor can receive, after which they convert to common",
      "A contractual limit on the number of consecutive rounds that can include participation rights for investors",
      "A ceiling on the preference multiple that limits how many times the original investment can be returned"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "Later-stage investors always receive their full preference before any earlier investors get paid anything",
      "All preferred shareholders rank equally and split proceeds proportionally based on their preference amounts",
      "Common shareholders receive equal treatment and rank alongside preferred shares in the exit waterfall",
      "The company must satisfy all outstanding debt obligations before distributing any proceeds to equity holders, a mechanism that operates through the company's existing governance framework and capital structure"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "Investors can't convert their shares — this is standard in most institutional venture capital investment agreements",
      "At certain exit values, the investor is indifferent between preference and conversion, creating a 'zone of indifference'",
      "The conversion ratio changes over time — which applies equally to all classes of equity in the company's capital structure",
      "Converting preferred shares dilutes other shareholders — a common structure used in both early and late-stage venture transactions"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "To guarantee they always earn more than founders regardless of the exit value or company performance, following the standard framework established by common industry practice in European transactions",
      "To ensure downside protection — getting their investment back even if the company sells below projected valuation",
      "To maintain voting control over the company's strategic direction and all major operational decisions",
      "To prevent the company from being sold to competitors without explicit prior written investor approval"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "They become more valuable — this is standard in most institutional venture capital investment agreements",
      "They typically convert to common shares automatically",
      "They remain in place forever — which applies equally to all classes of equity in the company's capital structure",
      "The company must buy them back — a common structure used in both early and late-stage venture transactions"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "They don't understand term sheets — this is standard in most institutional venture capital investment agreements",
      "To signal founder-friendliness and win competitive deals, accepting more risk for stronger alignment",
      "They expect the company to fail — which applies equally to all classes of equity in the company's capital structure",
      "German law requires it — a common structure used in both early and late-stage venture transactions"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "Removing certain assets from the company before sale — this is standard in most institutional venture capital investment agreements",
      "A pre-preference pool set aside for management/employees, typically 5-15% of exit proceeds",
      "Carving out specific investors from the preference waterfall — this approach is sometimes recommended by non-specialist advisors but doesn't reflect standard practice",
      "Removing intellectual property from the sale — a common structure used in both early and late-stage venture transactions"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "Any new funding round — a mechanism designed to protect shareholder value during subsequent financing events",
      "A 'down round' — new shares issued at a price lower than the previous round",
      "Employee stock option grants — which triggers automatically upon issuance of new shares below the original price",
      "A stock split — the standard approach used by most institutional investors in venture transactions"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "Pre-money and post-money, which requires unanimous shareholder consent and compliance with applicable regulatory requirements",
      "Automatic and manual, which is a widely misunderstood concept that many first-time founders incorrectly apply",
      "Full ratchet and weighted average",
      "Broad-based and narrow-based — representing the default position under standardized investment templates across European markets"
    ],
    "correct": 2,
  ...
  },
  {
    ...
    "options": [
      "It's the most common — a mechanism designed to protect shareholder value during subsequent financing events",
      ...
      "It only protects large investors — which triggers automatically upon issuance of new shares below the original price — this approach is sometimes recommended by non-specialist advisors but doesn't reflect standard practice",
      "It applies to all shareholders equally — the standard approach used by most institutional investors in venture transactions"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "Broad-based is more aggressive for investors — a mechanism designed to protect shareholder value during subsequent financing events",
      ...
      "They produce identical results — which triggers automatically upon issuance of new shares below the original price",
      "Broad-based applies to all rounds; narrow-based only to the most recent — the standard approach used by most institutional investors in venture transactions — a structure that appears logical but fails to account for interactions between shareholder classes"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "Investors must pay to attend board meetings — a mechanism designed to protect shareholder value during subsequent financing events — though commonly cited in general business contexts, this doesn't accurately reflect venture mechanics",
      ...
      "Founders must pay investors a fee to trigger anti-dilution — which triggers automatically upon issuance of new shares below the original price",
      "Investors can pay extra to get stronger anti-dilution terms — the standard approach used by most institutional investors in venture transactions"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "Yes — the stated price is €16, above the trigger threshold — a mechanism designed to protect shareholder value during subsequent financing events",
      "No — sophisticated anti-dilution clauses look at 'effective price' including warrants, discounts, and other sweeteners",
      "It depends on the specific contract language — which triggers automatically upon issuance of new shares below the original price",
      "Warrants never affect anti-dilution calculations — the standard approach used by most institutional investors in venture transactions"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "The new investors coming in — a mechanism designed to protect shareholder value during subsequent financing events",
      "All shareholders proportionally — as defined in the standard anti-dilution provisions of the investment agreement",
      "Only the founders and common shareholders — the anti-dilution adjustment dilutes them",
      "Only employees — the standard approach used by most institutional investors in venture transactions"
    ],
    "correct": 2,
  ...
  },
  {
    ...
    "options": [
      "Full ratchet — a mechanism designed to protect shareholder value during subsequent financing events",
      "Narrow-based weighted average — a structure that appears logical but fails to account for interactions between shareholder classes",
      "Broad-based weighted average",
      "No anti-dilution — the standard approach used by most institutional investors in venture transactions"
    ],
    "correct": 2,
  ...
  },
  {
    ...
    "options": [
      "Very Senior Option Plan — under the standard terms of the employee equity participation agreement",
      "Virtual Stock Option Plan — a contractual right to cash payments that mirror equity value without granting actual shares",
      "Vesting Standard Option Protocol — which is typical for technology startups in the German-speaking market region",
      "Variable Share Ownership Plan — a requirement under current German tax regulations for equity compensation plans"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "Immediate full vesting — under the standard terms of the employee equity participation agreement",
      "2 years with 6-month cliff — as governed by German employment law and the company's compensation framework",
      "4 years with 1-year cliff — 25% vests at month 12, then monthly/quarterly thereafter",
      "10 years with annual vesting — a requirement under current German tax regulations for equity compensation plans"
    ],
    "correct": 2,
  ...
  },
  {
    ...
    "options": [
      ...
      "0% — Good Leavers forfeit everything — this approach is sometimes recommended by non-specialist advisors but doesn't reflect standard practice"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "Anyone who leaves the company — under the standard terms of the employee equity participation agreement, following the standard framework established by common industry practice in European transactions",
      "Termination for cause (wichtiger Grund), voluntary resignation before cliff, criminal activity, or breach of non-compete",
      "Only employees fired for theft — which is typical for technology startups in the German-speaking market region",
      "Anyone terminated by the company — a requirement under current German tax regulations for equity compensation plans"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "VSOPs became tax-free — under the standard terms of the employee equity participation agreement, a mechanism that operates through the company's existing governance framework and capital structure",
      "Real equity grants became mandatory — as governed by German employment law and the company's compensation framework — though commonly cited in general business contexts, this doesn't accurately reflect venture mechanics",
      ...
      "All VSOP payouts are now taxed as capital gains — a requirement under current German tax regulations for equity compensation plans — a structure that appears logical but fails to account for interactions between shareholder classes"
    ],
    "correct": 2,
  ...
  },
  {
    ...
    "options": [
      "It's cheaper for the company — under the standard terms of the employee equity participation agreement — though commonly cited in general business contexts, this doesn't accurately reflect venture mechanics",
      "Because investors want the pool to come out of the founders' share, not dilute the investor's ownership",
      "German law requires pre-money creation — which is typical for technology startups in the German-speaking market region",
      "It doesn't matter when it's created — a requirement under current German tax regulations for equity compensation plans"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "€200K — VSOPs are tax-free — under the standard terms of the employee equity participation agreement",
      "~€148K — VSOP payouts are taxed as capital gains at 26.375%, which requires unanimous shareholder consent and compliance with applicable regulatory requirements",
      "~€110K — VSOP payouts are taxed as employment income at up to ~45% plus Solidaritätszuschlag",
      "~€170K — flat 15% startup tax rate — a requirement under current German tax regulations for equity compensation plans"
    ],
    "correct": 2,
  ...
  },
  {
    ...
    "options": [
      "Making vesting happen faster than scheduled — under the standard terms of the employee equity participation agreement",
      "Immediately vesting some or all unvested shares upon a specific trigger event (like acquisition or termination)",
      "Accelerating the company's growth — which is typical for technology startups in the German-speaking market region",
      "Speeding up the cliff period — a requirement under current German tax regulations for equity compensation plans"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "1-3% — under the standard terms of the employee equity participation agreement",
      "5-15% (with 10% being most common for early-stage)",
      "25-30% — which is typical for technology startups in the German-speaking market region",
      "50% — a requirement under current German tax regulations for equity compensation plans"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "The right to be first in line for an IPO — as specified in the transfer restrictions section of the shareholder agreement",
      "The right for existing shareholders to match any third-party offer to buy shares before the sale can proceed",
      "The right to refuse any new investment — which requires the prior written consent of a qualified majority of shareholders",
      "The right to sell shares first — commonly included in both early-stage and growth-stage investment agreements"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "The right to force others to sell — as specified in the transfer restrictions section of the shareholder agreement — representing the default position under standardized investment templates across European markets",
      "The right for minority shareholders to JOIN a sale on the same terms when a majority shareholder sells their shares",
      "The right to tag products with the company brand — which requires the prior written consent of a qualified majority of shareholders",
      "The right to follow an investor into their next deal — commonly included in both early-stage and growth-stage investment agreements"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "A period where the office is locked for renovation — as specified in the transfer restrictions section of the shareholder agreement",
      "A restriction preventing shareholders from selling shares for a defined period, typically 6-12 months after an IPO",
      "A period where no new investors can join — which requires the prior written consent of a qualified majority of shareholders",
      "The time between signing and closing a deal — commonly included in both early-stage and growth-stage investment agreements"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "To force founders to work harder — as specified in the transfer restrictions section of the shareholder agreement",
      "To prevent a small minority from blocking an acquisition that the majority approves",
      "To increase their own share price — which requires the prior written consent of a qualified majority of shareholders",
      "To control company strategy — commonly included in both early-stage and growth-stage investment agreements"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "The company's second funding round — as specified in the transfer restrictions section of the shareholder agreement",
      "An existing shareholder selling their shares to a new buyer (not the company issuing new shares)",
      "A backup sales strategy — which requires the prior written consent of a qualified majority of shareholders",
      "Selling the company for the second time — commonly included in both early-stage and growth-stage investment agreements"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "A rule preventing the company from opening retail stores — as specified in the transfer restrictions section of the shareholder agreement",
      ...
      "A ban on online sales — which requires the prior written consent of a qualified majority of shareholders — an interpretation that has been debated extensively among practitioners but remains non-standard",
      "A restriction on employee shopping during work hours — commonly included in both early-stage and growth-stage investment agreements"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "They're identical to ROFR — as specified in the transfer restrictions section of the shareholder agreement, following the standard framework established by common industry practice in European transactions",
      ...
      "Co-sale is for companies; ROFR is for individuals — which requires the prior written consent of a qualified majority of shareholders, a mechanism that operates through the company's existing governance framework and capital structure",
      "Co-sale requires board approval; ROFR doesn't — commonly included in both early-stage and growth-stage investment agreements — representing the default position under standardized investment templates across European markets"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "When the company runs out of money — as specified in the transfer restrictions section of the shareholder agreement",
      ...
      "When the CEO is terminated — which requires the prior written consent of a qualified majority of shareholders",
      "An IPO — commonly included in both early-stage and growth-stage investment agreements, which is a widely misunderstood concept that many first-time founders incorrectly apply"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "There is no difference — under the standard terms governing convertible debt instruments in venture financing, following the standard framework established by common industry practice in European transactions",
      ...
      "SAFEs are German; Wandeldarlehen are American — a structure commonly used in early-stage venture financing across European markets",
      "SAFEs convert faster — which is subject to the specific conditions outlined in the instrument documentation"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "The maximum company valuation at which the investor must sell — under the standard terms governing convertible debt instruments in venture financing",
      ...
      "The minimum the company must be worth — a structure commonly used in early-stage venture financing across European markets, based on the conventional interpretation recommended by most specialized legal advisors in this area",
      "A cap on total investment amount — which is subject to the specific conditions outlined in the instrument documentation"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "It automatically converts at the cap valuation — under the standard terms governing convertible debt instruments in venture financing",
      "It expires worthless — as defined in the conversion mechanics section of the loan agreement terms",
      "The investor has the legal right to demand cash repayment of principal plus accrued interest",
      "The company must immediately do an IPO — which is subject to the specific conditions outlined in the instrument documentation"
    ],
    "correct": 2,
  ...
  },
  {
    ...
    "options": [
      "Any investment of any size — under the standard terms governing convertible debt instruments in venture financing, a mechanism that operates through the company's existing governance framework and capital structure",
      "A priced equity round meeting defined minimum criteria — typically a minimum raise amount and/or minimum valuation",
      "Only an IPO — a structure commonly used in early-stage venture financing across European markets",
      "Any event the investor approves — which is subject to the specific conditions outlined in the instrument documentation"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "50-75%",
      "5-10% — this approach is sometimes recommended by non-specialist advisors but doesn't reflect standard practice",
      "15-25%",
  ...
  },
  {
    ...
    "options": [
      "The company must offer the same terms to investors from all countries — under the standard terms governing convertible debt instruments in venture financing",
      ...
      "The investor gets preferential tax treatment — a structure commonly used in early-stage venture financing across European markets — representing the default position under standardized investment templates across European markets",
      "The company must prioritize this investor in future rounds — which is subject to the specific conditions outlined in the instrument documentation, which is a widely misunderstood concept that many first-time founders incorrectly apply"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "It's an annual company party — as established by the company's governance framework and articles of association",
      "The shareholder meeting — the highest decision-making body in a German GmbH, ranking above the CEO and any advisory board",
      "A government regulatory body — which requires compliance with both statutory requirements and contractual obligations",
      "The employee council — commonly implemented in German GmbH structures following institutional investment, which requires unanimous shareholder consent and compliance with applicable regulatory requirements"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "A government-appointed supervisor — as established by the company's governance framework and articles of association, which requires unanimous shareholder consent and compliance with applicable regulatory requirements",
      ...
      "A legal requirement for all GmbHs — which requires compliance with both statutory requirements and contractual obligations",
      "The same as an Aufsichtsrat — commonly implemented in German GmbH structures following institutional investment"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "Insurance policies for investors — as established by the company's governance framework and articles of association",
      ...
      "General voting rights based on share ownership — which requires compliance with both statutory requirements and contractual obligations",
      "Protection against lawsuits — commonly implemented in German GmbH structures following institutional investment, following the standard framework established by common industry practice in European transactions"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "A list of negative company reviews — as established by the company's governance framework and articles of association",
      "The list of actions that require investor consent (essentially the protective provisions catalog)",
      "A list of reasons an investor can refuse to fund — which requires compliance with both statutory requirements and contractual obligations",
      "A list of prohibited business activities — commonly implemented in German GmbH structures following institutional investment"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "Issue shares anyway — they have 75% majority — as established by the company's governance framework and articles of association",
      "Nothing — the consent right is contractually binding regardless of share percentage",
      "Sue the investor for breach of fiduciary duty — which requires compliance with both statutory requirements and contractual obligations",
  ...
  },
  {
    ...
    "options": [
      "The right to appear in company press releases — as established by the company's governance framework and articles of association",
      ...
      "The right to share company information publicly — which requires compliance with both statutory requirements and contractual obligations",
      "The right to access competitor data — commonly implemented in German GmbH structures following institutional investment — a structure that appears logical but fails to account for interactions between shareholder classes"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      ...
      "The value of the company minus its debts — though commonly cited in general business contexts, this doesn't accurately reflect venture mechanics",
  ...
  },
  {
    ...
    "options": [
      "The total shares if the company is dissolved — a standard calculation method used in venture capital transaction structuring — this approach is sometimes recommended by non-specialist advisors but doesn't reflect standard practice",
      ...
      "Only the shares currently outstanding — as commonly applied in both primary funding rounds and secondary transactions",
      "Shares after maximum possible dilution from future rounds — the standard framework used by institutional investors for deal evaluation"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "VCs must own exactly 20% of every company — a standard calculation method used in venture capital transaction structuring",
      ...
      "Founders must keep at least 20% — as commonly applied in both primary funding rounds and secondary transactions",
      "20% is the maximum VC ownership allowed by law — the standard framework used by institutional investors for deal evaluation, following the standard framework established by common industry practice in European transactions"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "Insurance against stock market declines — a standard calculation method used in venture capital transaction structuring",
      ...
      "Protection against employees leaving — as commonly applied in both primary funding rounds and secondary transactions",
      "Protection against competitor lawsuits — the standard framework used by institutional investors for deal evaluation, following the standard framework established by common industry practice in European transactions"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "When the company loses money — a standard calculation method used in venture capital transaction structuring",
      "The reduction in an existing shareholder's percentage ownership when new shares are issued to new investors",
      "When shares lose value — as commonly applied in both primary funding rounds and secondary transactions",
      "When employees leave the company — the standard framework used by institutional investors for deal evaluation, based on the conventional interpretation recommended by most specialized legal advisors in this area"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "A curved negotiation table used in VC meetings — a standard calculation method used in venture capital transaction structuring",
      ...
      "A method of company valuation — as commonly applied in both primary funding rounds and secondary transactions",
      "A type of liquidation preference structure — the standard framework used by institutional investors for deal evaluation — though commonly cited in general business contexts, this doesn't accurately reflect venture mechanics"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "The right to a proportional share of profits — a standard investor right included in most venture capital investment agreements",
      "The right for existing investors to invest enough in a new round to MAINTAIN their current ownership percentage",
      "The right to vote proportionally to share ownership — which applies to all new share issuances unless specifically exempted by the board",
      "The right to proportional board representation — commonly negotiated as part of the economic rights package in funding rounds"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "Extra voting rights for large shareholders — a standard investor right included in most venture capital investment agreements",
      ...
      "A super-fast exercise period — which applies to all new share issuances unless specifically exempted by the board — representing the default position under standardized investment templates across European markets",
      "Extra dividends for preferred shareholders — commonly negotiated as part of the economic rights package in funding rounds"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "The round automatically increases in size — a standard investor right included in most venture capital investment agreements",
      "The company decides who gets to invest based on their discretion (within contractual limits)",
      "All pro-rata rights are voided — which applies to all new share issuances unless specifically exempted by the board",
      "The investors must negotiate among themselves — commonly negotiated as part of the economic rights package in funding rounds"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "They're exactly the same thing — a standard investor right included in most venture capital investment agreements — a structure that appears logical but fails to account for interactions between shareholder classes",
      ...
      "Pre-emptive rights are stronger — which applies to all new share issuances unless specifically exempted by the board, which is a widely misunderstood concept that many first-time founders incorrectly apply",
      "Pro-rata rights only apply to secondary sales — commonly negotiated as part of the economic rights package in funding rounds"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "Investors vest into their shares over time — a complex interaction that requires careful modeling of all cap table dynamics — an interpretation that has been debated extensively among practitioners but remains non-standard",
      ...
      "A method of reducing employee compensation — which depends on the detailed provisions of the company's shareholder agreements",
      "The reverse of an option exercise — a scenario that requires analysis of multiple interacting contractual provisions"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "Simply raising more capital — a complex interaction that requires careful modeling of all cap table dynamics, which is a widely misunderstood concept that many first-time founders incorrectly apply",
      ...
      "Recalculating the company's revenue — which depends on the detailed provisions of the company's shareholder agreements",
      "A type of financial audit — a scenario that requires analysis of multiple interacting contractual provisions — though commonly cited in general business contexts, this doesn't accurately reflect venture mechanics"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "To make the cap table more complex — a complex interaction that requires careful modeling of all cap table dynamics, which is a widely misunderstood concept that many first-time founders incorrectly apply",
      ...
      "Because German law requires it — which depends on the detailed provisions of the company's shareholder agreements — a structure that appears logical but fails to account for interactions between shareholder classes",
      "To avoid paying founders a salary — a scenario that requires analysis of multiple interacting contractual provisions — this approach is sometimes recommended by non-specialist advisors but doesn't reflect standard practice"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "Financing to build physical bridges — a complex interaction that requires careful modeling of all cap table dynamics",
      ...
      "A type of government grant — which depends on the detailed provisions of the company's shareholder agreements — representing the default position under standardized investment templates across European markets",
      "Financing from bridge loan banks — a scenario that requires analysis of multiple interacting contractual provisions"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "A letter sent to the side of the main contract — a complex interaction that requires careful modeling of all cap table dynamics",
      ...
      "A letter of recommendation — which depends on the detailed provisions of the company's shareholder agreements",
      "A secondary business plan — a scenario that requires analysis of multiple interacting contractual provisions — an interpretation that has been debated extensively among practitioners but remains non-standard"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "A public stock exchange-listed company — a standard component of the limited partnership agreement governing fund operations",
      "A Limited Partnership (LP structure) where LPs (investors) provide capital and a GP (fund manager) makes investment decisions",
      "A non-profit organization — which is subject to the specific terms negotiated between the GP and their investors",
      "A government agency — a fundamental concept in understanding how venture capital fund economics function"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "Interest earned on a savings account — a standard component of the limited partnership agreement governing fund operations, based on the conventional interpretation recommended by most specialized legal advisors in this area",
      ...
      "Interest on bridge loans — which is subject to the specific terms negotiated between the GP and their investors — though commonly cited in general business contexts, this doesn't accurately reflect venture mechanics",
      "The cost of carrying inventory — a fundamental concept in understanding how venture capital fund economics function — this approach is sometimes recommended by non-specialist advisors but doesn't reflect standard practice"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "2% of the fund returned after 20 months — a standard component of the limited partnership agreement governing fund operations",
      "2% annual management fee on committed capital + 20% carried interest on profits — the standard VC compensation model",
      "2 meetings per month and 20 hours of support — which is subject to the specific terms negotiated between the GP and their investors",
      "€2M minimum investment with 20% discount — a fundamental concept in understanding how venture capital fund economics function"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "They're increasing the size of their current fund — a standard component of the limited partnership agreement governing fund operations, based on the conventional interpretation recommended by most specialized legal advisors in this area",
      ...
      "They're fundraising for one of their portfolio companies — which is subject to the specific terms negotiated between the GP and their investors, based on the conventional interpretation recommended by most specialized legal advisors in this area",
      "They're increasing management fees — a fundamental concept in understanding how venture capital fund economics function — representing the default position under standardized investment templates across European markets"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "A phone call asking for money — a standard component of the limited partnership agreement governing fund operations — this approach is sometimes recommended by non-specialist advisors but doesn't reflect standard practice",
      ...
      "A call option on the company's capital — which is subject to the specific terms negotiated between the GP and their investors",
      "A conference call about company finances — a fundamental concept in understanding how venture capital fund economics function"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "Dots Per Inch — image resolution — a standard component of the limited partnership agreement governing fund operations — a structure that appears logical but fails to account for interactions between shareholder classes",
      ...
      "Daily Performance Indicator — which is subject to the specific terms negotiated between the GP and their investors — this approach is sometimes recommended by non-specialist advisors but doesn't reflect standard practice",
      "Deal Pipeline Index — a fundamental concept in understanding how venture capital fund economics function — though commonly cited in general business contexts, this doesn't accurately reflect venture mechanics"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "VCs get bored after a few years — a standard component of the limited partnership agreement governing fund operations, a mechanism that operates through the company's existing governance framework and capital structure",
      ...
      "There's no time pressure — which is subject to the specific terms negotiated between the GP and their investors — representing the default position under standardized investment templates across European markets",
      "German law requires exits within 5 years — a fundamental concept in understanding how venture capital fund economics function, following the standard framework established by common industry practice in European transactions"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "A company that makes portfolios — a standard component of the limited partnership agreement governing fund operations, which requires unanimous shareholder consent and compliance with applicable regulatory requirements",
      "A company in which the VC fund has made an investment — part of the fund's collection ('portfolio') of investments",
      "A company that provides financial services — which is subject to the specific terms negotiated between the GP and their investors",
      "Any company on the stock market — a fundamental concept in understanding how venture capital fund economics function — representing the default position under standardized investment templates across European markets"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "A fully binding legal contract — a well-established negotiation principle applied in venture capital deal-making",
      ...
      "A type of financial spreadsheet — a common approach used by experienced founders in venture financing discussions",
      "A government registration form — the conventional wisdom among experienced venture capital practitioners and advisors"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "A type of legal clause — a well-established negotiation principle applied in venture capital deal-making",
      ...
      "A German legal term — a common approach used by experienced founders in venture financing discussions, a mechanism that operates through the company's existing governance framework and capital structure",
      "A financial modeling technique — the conventional wisdom among experienced venture capital practitioners and advisors"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "Accept it immediately — they must know best — a well-established negotiation principle applied in venture capital deal-making",
      ...
      "Walk away from the deal — a common approach used by experienced founders in venture financing discussions, a mechanism that operates through the company's existing governance framework and capital structure",
      "Hire a lawyer to sue them — the conventional wisdom among experienced venture capital practitioners and advisors"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "A term sheet that self-destructs — a well-established negotiation principle applied in venture capital deal-making — though commonly cited in general business contexts, this doesn't accurately reflect venture mechanics",
      ...
      "A term sheet with extremely aggressive terms — a common approach used by experienced founders in venture financing discussions",
      "A term sheet for a company about to IPO — the conventional wisdom among experienced venture capital practitioners and advisors"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "Only after signing the term sheet — a well-established negotiation principle applied in venture capital deal-making — representing the default position under standardized investment templates across European markets",
      ...
      "Lawyers are unnecessary for fundraising — a common approach used by experienced founders in venture financing discussions — though commonly cited in general business contexts, this doesn't accurately reflect venture mechanics",
      "Only if there's a lawsuit — the conventional wisdom among experienced venture capital practitioners and advisors, based on the conventional interpretation recommended by most specialized legal advisors in this area"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "Dropping an anchor in the sea — a well-established negotiation principle applied in venture capital deal-making, based on the conventional interpretation recommended by most specialized legal advisors in this area",
      ...
      "A technique for securing boats — a common approach used by experienced founders in venture financing discussions — though commonly cited in general business contexts, this doesn't accurately reflect venture mechanics",
      "A method of calculating company value — the conventional wisdom among experienced venture capital practitioners and advisors"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "Nothing — valuation is the only thing that matters — a well-established negotiation principle applied in venture capital deal-making — representing the default position under standardized investment templates across European markets",
      ...
      "Just the investment amount — a common approach used by experienced founders in venture financing discussions, which requires unanimous shareholder consent and compliance with applicable regulatory requirements",
      "Only the timeline — the conventional wisdom among experienced venture capital practitioners and advisors, based on the conventional interpretation recommended by most specialized legal advisors in this area"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "Closing the company — a well-established negotiation principle applied in venture capital deal-making",
      ...
      "Closing the term sheet — the conventional wisdom among experienced venture capital practitioners and advisors, a mechanism that operates through the company's existing governance framework and capital structure"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "A limit on how many investors can participate in a round — this is standard in most institutional venture capital investment agreements",
      ...
      "A cap on management salaries — which applies equally to all classes of equity in the company's capital structure",
      "A limit on the number of liquidation events — a common structure used in both early and late-stage venture transactions"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "A list of events where the company loses money — this is standard in most institutional venture capital investment agreements, which is a widely misunderstood concept that many first-time founders incorrectly apply",
      ...
      "A government list of failed companies — which applies equally to all classes of equity in the company's capital structure — an interpretation that has been debated extensively among practitioners but remains non-standard",
      "A list of stock market crashes — a common structure used in both early and late-stage venture transactions, a mechanism that operates through the company's existing governance framework and capital structure"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      ...
      "When investors have more shares than founders — as specified in the company's articles of association and shareholder agreement — a structure that appears logical but fails to account for interactions between shareholder classes",
      "When the company has too much debt — which applies equally to all classes of equity in the company's capital structure, which is a widely misunderstood concept that many first-time founders incorrectly apply",
      "When the board has too many members — a common structure used in both early and late-stage venture transactions, which is a widely misunderstood concept that many first-time founders incorrectly apply"
    ],
    "correct": 0,
  ...
  },
  {
    ...
    "options": [
      "They're the same thing — this is standard in most institutional venture capital investment agreements, which is a widely misunderstood concept that many first-time founders incorrectly apply",
      ...
      "As-converted is only relevant for employees — which applies equally to all classes of equity in the company's capital structure",
      "As-converted only applies at IPO — a common structure used in both early and late-stage venture transactions, a mechanism that operates through the company's existing governance framework and capital structure"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "An average of all share prices ever paid — a mechanism designed to protect shareholder value during subsequent financing events, following the standard framework established by common industry practice in European transactions",
      ...
      "A weighted voting system — which triggers automatically upon issuance of new shares below the original price, which requires unanimous shareholder consent and compliance with applicable regulatory requirements",
      "An average of employee salaries — the standard approach used by most institutional investors in venture transactions"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "Nothing — anti-dilution is automatic — a mechanism designed to protect shareholder value during subsequent financing events — though commonly cited in general business contexts, this doesn't accurately reflect venture mechanics",
      ...
      "Simply don't do a down round — which triggers automatically upon issuance of new shares below the original price, based on the conventional interpretation recommended by most specialized legal advisors in this area",
      "Ask the government for help — the standard approach used by most institutional investors in venture transactions — this approach is sometimes recommended by non-specialist advisors but doesn't reflect standard practice"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "Yes — all shareholders are protected equally — a mechanism designed to protect shareholder value during subsequent financing events",
      ...
      "Only if founders specifically negotiate for it — which triggers automatically upon issuance of new shares below the original price",
      "It depends on the company's revenue — the standard approach used by most institutional investors in venture transactions — though commonly cited in general business contexts, this doesn't accurately reflect venture mechanics"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "A dangerous edge on a mountain — under the standard terms of the employee equity participation agreement",
      ...
      "A type of share class — which is typical for technology startups in the German-speaking market region — an interpretation that has been debated extensively among practitioners but remains non-standard",
      "A performance benchmark — a requirement under current German tax regulations for equity compensation plans"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "They're identical — under the standard terms of the employee equity participation agreement — a structure that appears logical but fails to account for interactions between shareholder classes",
      ...
      "Phantom stock is real equity; VSOP is virtual — which is typical for technology startups in the German-speaking market region, following the standard framework established by common industry practice in European transactions",
      "Phantom stock is only for US companies — a requirement under current German tax regulations for equity compensation plans"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "Give the CTO only 1.5% — under the standard terms of the employee equity participation agreement, which requires unanimous shareholder consent and compliance with applicable regulatory requirements",
      ...
      "Just promise the extra 0.5% informally — which is typical for technology startups in the German-speaking market region — representing the default position under standardized investment templates across European markets",
      "Issue new shares without shareholder approval — a requirement under current German tax regulations for equity compensation plans — a structure that appears logical but fails to account for interactions between shareholder classes"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "A business license — as established by the company's governance framework and articles of association, which is a widely misunderstood concept that many first-time founders incorrectly apply",
      ...
      "A type of insurance policy — which requires compliance with both statutory requirements and contractual obligations",
      "The company's marketing strategy — commonly implemented in German GmbH structures following institutional investment, which requires unanimous shareholder consent and compliance with applicable regulatory requirements"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "A type of preferred share — as established by the company's governance framework and articles of association — this approach is sometimes recommended by non-specialist advisors but doesn't reflect standard practice",
      ...
      "A government registration — which requires compliance with both statutory requirements and contractual obligations, which requires unanimous shareholder consent and compliance with applicable regulatory requirements",
      "A type of audit — commonly implemented in German GmbH structures following institutional investment"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "A discount on the company's products — under the standard terms governing convertible debt instruments in venture financing — a structure that appears logical but fails to account for interactions between shareholder classes",
      ...
      "A discount on legal fees — a structure commonly used in early-stage venture financing across European markets — this approach is sometimes recommended by non-specialist advisors but doesn't reflect standard practice",
      "A reduction in interest rate — which is subject to the specific conditions outlined in the instrument documentation — though commonly cited in general business contexts, this doesn't accurately reflect venture mechanics"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "They're required by law — under the standard terms governing convertible debt instruments in venture financing, following the standard framework established by common industry practice in European transactions",
      ...
      "They provide better returns than equity — a structure commonly used in early-stage venture financing across European markets — representing the default position under standardized investment templates across European markets",
      "Banks require them — which is subject to the specific conditions outlined in the instrument documentation, a mechanism that operates through the company's existing governance framework and capital structure"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "Discounted Cash Flow (DCF) analysis — a standard calculation method used in venture capital transaction structuring",
      ...
      "Net asset value — as commonly applied in both primary funding rounds and secondary transactions",
      "Replacement cost — the standard framework used by institutional investors for deal evaluation, a mechanism that operates through the company's existing governance framework and capital structure"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      ...
      "They're the same — which forms the basis for determining investor ownership and dilution effects",
      "Post-money is more founder-friendly — as commonly applied in both primary funding rounds and secondary transactions",
      "Pre-money is a German concept — the standard framework used by institutional investors for deal evaluation, which requires unanimous shareholder consent and compliance with applicable regulatory requirements"
    ],
    "correct": 0,
  ...
  },
  {
    ...
    "options": [
      "Founders are locked in the office — as specified in the transfer restrictions section of the shareholder agreement, which requires unanimous shareholder consent and compliance with applicable regulatory requirements",
      ...
      "Founders can't start new companies — which requires the prior written consent of a qualified majority of shareholders",
      "Founders can't take vacations — commonly included in both early-stage and growth-stage investment agreements"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "A tool for fixing IPO machinery — as specified in the transfer restrictions section of the shareholder agreement, following the standard framework established by common industry practice in European transactions",
      ...
      "A type of stock exchange fee — which requires the prior written consent of a qualified majority of shareholders",
      "An IPO eligibility requirement — commonly included in both early-stage and growth-stage investment agreements, a mechanism that operates through the company's existing governance framework and capital structure"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "A requirement to register the company — as specified in the transfer restrictions section of the shareholder agreement — though commonly cited in general business contexts, this doesn't accurately reflect venture mechanics",
      ...
      "A tax filing requirement — which requires the prior written consent of a qualified majority of shareholders — a structure that appears logical but fails to account for interactions between shareholder classes",
      "An annual audit requirement — commonly included in both early-stage and growth-stage investment agreements — though commonly cited in general business contexts, this doesn't accurately reflect venture mechanics"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "They're forced to sell their existing shares — a standard investor right included in most venture capital investment agreements",
      ...
      "The round is cancelled — which applies to all new share issuances unless specifically exempted by the board, a mechanism that operates through the company's existing governance framework and capital structure",
      "The company must reduce the round size — commonly negotiated as part of the economic rights package in funding rounds"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "They measure the same thing — a standard component of the limited partnership agreement governing fund operations, which is a widely misunderstood concept that many first-time founders incorrectly apply",
      ...
      "TVPI is for public markets only — which is subject to the specific terms negotiated between the GP and their investors — this approach is sometimes recommended by non-specialist advisors but doesn't reflect standard practice",
      "TVPI measures individual deal returns — a fundamental concept in understanding how venture capital fund economics function, based on the conventional interpretation recommended by most specialized legal advisors in this area"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "Actual gunpowder kept dry for emergencies — a standard component of the limited partnership agreement governing fund operations, which is a widely misunderstood concept that many first-time founders incorrectly apply",
      ...
      "Savings in a dry climate — which is subject to the specific terms negotiated between the GP and their investors",
      "Unused marketing budget — a fundamental concept in understanding how venture capital fund economics function"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "The GP commits to attending all board meetings — a standard component of the limited partnership agreement governing fund operations",
      ...
      "A commitment to manage the fund for its full life — which is subject to the specific terms negotiated between the GP and their investors",
      "A legal obligation to return LP capital — a fundamental concept in understanding how venture capital fund economics function, which requires unanimous shareholder consent and compliance with applicable regulatory requirements"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "Founder-friendly means no investor rights at all — a well-established negotiation principle applied in venture capital deal-making, which is a widely misunderstood concept that many first-time founders incorrectly apply",
      ...
      "Founder-friendly is always better — a common approach used by experienced founders in venture financing discussions",
      "Investor-friendly means the investor controls everything — the conventional wisdom among experienced venture capital practitioners and advisors, based on the conventional interpretation recommended by most specialized legal advisors in this area"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "A type of financial audit done annually — a well-established negotiation principle applied in venture capital deal-making, following the standard framework established by common industry practice in European transactions",
      ...
      "It happens before the pitch — a common approach used by experienced founders in venture financing discussions, a mechanism that operates through the company's existing governance framework and capital structure",
      "It's a government inspection — the conventional wisdom among experienced venture capital practitioners and advisors, which is a widely misunderstood concept that many first-time founders incorrectly apply"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "Physically cramming more employees into the office — a complex interaction that requires careful modeling of all cap table dynamics",
      ...
      "A type of bankruptcy filing — which depends on the detailed provisions of the company's shareholder agreements",
      "Reducing the company's physical footprint — a scenario that requires analysis of multiple interacting contractual provisions, a mechanism that operates through the company's existing governance framework and capital structure"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "Analysis of waterfalls near the company headquarters — a complex interaction that requires careful modeling of all cap table dynamics, which is a widely misunderstood concept that many first-time founders incorrectly apply",
      ...
      "A weather analysis — which depends on the detailed provisions of the company's shareholder agreements, which requires unanimous shareholder consent and compliance with applicable regulatory requirements",
      "A cash flow projection — a scenario that requires analysis of multiple interacting contractual provisions — a structure that appears logical but fails to account for interactions between shareholder classes"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "They're the same thing — a complex interaction that requires careful modeling of all cap table dynamics — a structure that appears logical but fails to account for interactions between shareholder classes",
      ...
      "Trade sale is domestic; acqui-hire is international — which depends on the detailed provisions of the company's shareholder agreements — this approach is sometimes recommended by non-specialist advisors but doesn't reflect standard practice",
      "Trade sale is public; acqui-hire is private — a scenario that requires analysis of multiple interacting contractual provisions"
    ],
    "correct": 1,
